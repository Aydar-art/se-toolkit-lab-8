[2026-04-01 08:21] 🔍 Scheduled Health Check: Found 1 ERROR in Learning Management Service (last 2 min). Database connection failure - DNS resolution error "[Errno -2] Name or service not known" on db_query operation. Trace ID: 06a06ca5841b3c67d9bf7434b7eb3b66. Root cause: LMS backend cannot resolve database hostname. Recommendation: Check DB service status and DNS configuration. NOTE: WebChat message delivery failed (server disconnected).
